"""
Complete Chat API for FindersKeepers v2
...
class ChatService:
    ...
    async def _query_knowledge_graph(self, query: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            # For now, return mock results based on common queries
                ...
                return [
                    {
                        ...
                        "relevance": 0.9,
                        "relationships": ["RUNS", "MANAGES", "DEPLOYS"]
                    }
                ]
            elif "finderskeepers" in query.lower() or "system" in query.lower():
                return [
                    {
                        "type": "entity",
                        "id": "finderskeepers_v2",
